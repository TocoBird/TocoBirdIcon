...
export const IconTapioka: React.FC<Props> = (props) => (
  <svg
    width={props.width}
    height={props.height}
    viewBox="0 0 109 109"
      ...
      <g id="tocobird_tapioka">
        <g id="Group-2" transform="translate(6.000000, 0.000000)">
          ...
          <g id="Group" transform="translate(18.000000, 0.000000)">
            ...
            />
            <path
              d="M2,54 L58,54 L58,94 L58,94 C58,100.627417 52.627417,106 46,106 L14,106 L14,106 C7.372583,106 2,100.627417 2,94 L2,54 Z"
              id="Rectangle-10"
              fill="#F1D1B5"
            />
            <rect
            ...
            />
            <path
              d="M7,25 L53,25 L53,25 C55.7614237,25 58,27.2385763 58,30 L58,30 L2,30 L2,30 L2,30 C2,27.2385763 4.23857625,25 7,25 Z"
              id="Rectangle-10"
              fill="#E4CEC1"
            />
            <path
              d="M2.5,33.5 L2.5,94 C2.5,100.351275 7.64872538,105.5 14,105.5 L46,105.5 C52.3512746,105.5 57.5,100.351275 57.5,94 L57.5,33.5 L2.5,33.5 Z"
              id="Rectangle-10"
              stroke="#C49661"
            />
            <rect
